...
# MAX_HISTORY_TURNS 상수 선언 위치 - (import문 아래, 클래스 선언 위)
MAX_HISTORY_TURNS = 3  # 최근 3턴만 대화 맥락에 포함
...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        # main6.py의 MainWindow 또는 챗봇 메인 클래스의 __init__에 아래 코드 추가
        # 클래스 멤버 변수로 history 추가
